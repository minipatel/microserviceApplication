...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "microservice1@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "microservice1 API";

        private String description = "microservice1 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "microservice1";
